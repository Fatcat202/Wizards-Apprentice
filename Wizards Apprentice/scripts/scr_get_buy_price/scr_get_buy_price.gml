...
function scr_get_buy_price(item)
{
	// Check if buy price should be added or subtracted from base item price
	...
	total_price_mod = (base_price * ((global.charisma-global.charisma_average) * global.price_mod))*-1
