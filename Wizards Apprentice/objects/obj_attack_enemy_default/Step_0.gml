...
#region Projectile Determination
	...
	if(move_spd != -1)
	{
		...
		if(interact_delay_active == false && place_meeting(x, y, obj_platform_solid_parent) || place_meeting(x, y, obj_player_parent) || place_meeting(x, y, obj_platform_void_parent))
		{
			instance_destroy()
		}
