	...
	#region Variables
		...
		#region Database
			...
			#region Enemy Stats
				...
				// Initialize stats dictionary constructor
				function enemy_stats(_hp = -1, _move_spd = -1, _flies = -1, _is_melee = -1, _can_jump = -1, _min_range = -1, _vision_range = -1, _caster = -1, _xp = -1) constructor {
				...
				for(var i = 0; i < global.enemy_index_length; i++)
				{
					...
					global.enemy_stats[yy].is_melee = bool(ds_grid_get(ds_enemy_stats_csv, xx, yy)); xx++;
...
//			show_debug_message("global.level_stats: " + string(global.level_stats))
		...
		#region Inventory Contents
			...
			#region Hard coded spells for testing
				...
				global.active_spells[0, 1] = global.spell_stats[scr_find_spell_index("icicle")]
				global.active_spells[0, 2] = global.spell_stats[scr_find_spell_index("firebolt")]
